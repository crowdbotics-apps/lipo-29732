...
admin.site.site_header = "Lipo"
admin.site.site_title = "Lipo Admin Portal"
admin.site.index_title = "Lipo Admin"

# swagger
api_info = openapi.Info(
    title="Lipo API",
    default_version="v1",
    description="API documentation for Lipo App",
)
